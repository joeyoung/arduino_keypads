...
Keypad_MCP numpad( makeKeymap(numberKeys), rowPins, colPins, sizeof(rowPins), sizeof(colPins), I2CADDR );
Keypad_MCP ltrpad( makeKeymap(alphaKeys), rowPins, colPins, sizeof(rowPins), sizeof(colPins), I2CADDR );
Keypad_MCP keypad = numpad;
